  ...
  return (
    <>
      <style>{`
        ...
        .ph-desktop-note { font-size:0.75rem; color:#475569; display:flex; align-items:center; gap:0.4rem; }
      ...
      <div className="ph-page">
        ...
        <div className="ph-hero">
          ...
          <p className="ph-desktop-note">💻 Full experience available on desktop</p>
        </div>
