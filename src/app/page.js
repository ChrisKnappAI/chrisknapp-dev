  ...
  return (
    <>
      <style>{`
        ...
        .ck-hero-photo { position:absolute; left:44%; right:2rem; top:3.5rem; bottom:-80px; z-index:1; }
        .ck-hero-photo img { width:100%; height:100%; object-fit:contain; object-position:top center; filter:contrast(1.1) brightness(0.95); display:block; }
      ...
      <div className="ck-page">
        ...
        <div className="ck-hero-grid">
          ...
          <div className="ck-hero-photo">
            <img src="/chris-knapp.png" alt="Chris Knapp" />
          </div>
        </div>
        ...
        <div className="ck-stats-bar">
          <div className="ck-stats-inner">
            <div className="ck-stat-item">
              ...
              <div className="ck-stat-label">Annual Profit<br />From Projects</div>
            </div>
            <div className="ck-stat-item">
