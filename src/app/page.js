  ...
  return (
    <>
      <style>{`
        ...
        .ck-hero-photo { position:absolute; left:44%; right:2rem; top:6rem; bottom:0; z-index:1; overflow:visible; }
        .ck-hero-photo img { width:100%; height:auto; display:block; filter:contrast(1.1) brightness(0.95); }
