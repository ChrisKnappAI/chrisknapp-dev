...
const css = `
  ...
  .bubble-in { animation: pop-in 0.25s cubic-bezier(0.34,1.56,0.64,1) both; }
  @keyframes pop-in {
  ...
  .kicking {
    animation: kick-anim 7s linear forwards;
    transform-origin: bottom center;
  }
  ...
  @keyframes magic-anim {
    ...
    10%  { transform: translate(0,-20px)   scale(1.1)  rotate(100deg); opacity: 1; }
    22%  { transform: translate(0,-55px)   scale(0.72) rotate(260deg); opacity: 1; }
    34%  { transform: translate(0,-95px)   scale(0.28) rotate(450deg); opacity: 0.7; }
    42%  { transform: translate(0,-120px)  scale(0.04) rotate(600deg); opacity: 0; }
    50%  { transform: translate(0,-120px)  scale(0.04) rotate(600deg); opacity: 0; }
    52%  { transform: translate(860px,0) scale(1)    rotate(0deg);   opacity: 0; }
    56%  { transform: translate(860px,0) scale(1)    rotate(0deg);   opacity: 1; }
    63%  { transform: translate(700px,0) scale(1)    rotate(-12deg); opacity: 1; }
    69%  { transform: translate(552px,0) scale(1)    rotate(12deg);  opacity: 1; }
    75%  { transform: translate(412px,0) scale(1)    rotate(-11deg); opacity: 1; }
    80%  { transform: translate(286px,0) scale(1)    rotate(10deg);  opacity: 1; }
    85%  { transform: translate(178px,0) scale(1)    rotate(-9deg);  opacity: 1; }
    89%  { transform: translate(90px,0)  scale(1)    rotate(8deg);   opacity: 1; }
    93%  { transform: translate(33px,0)  scale(1)    rotate(-5deg);  opacity: 1; }
    97%  { transform: translate(7px,0)   scale(1)    rotate(3deg);   opacity: 1; }
    100% { transform: translate(0,0)     scale(1)    rotate(0deg);   opacity: 1; }
  }
  .magicking { animation: magic-anim 8s linear forwards; transform-origin: bottom center; }

  /* LAY EGG */
  @keyframes layegg-anim {
    0%   { transform: translate(0,0)    rotate(0deg)    scaleY(1);    }
    8%   { transform: translate(0,0)    rotate(0deg)    scaleY(0.82); }
    14%  { transform: translate(0,0)    rotate(0deg)    scaleY(0.78); }
    20%  { transform: translate(0,0)    rotate(0deg)    scaleY(0.84); }
    24%  { transform: translate(0,0)    rotate(0deg)    scaleY(1);    }
    32%  { transform: translate(80px,0) rotate(-10deg)  scaleY(1);    }
    37%  { transform: translate(80px,0) rotate(10deg)   scaleY(1);    }
    41%  { transform: translate(80px,0) rotate(-8deg)   scaleY(1);    }
    45%  { transform: translate(80px,0) rotate(0deg)    scaleY(1);    }
    62%  { transform: translate(80px,0) rotate(0deg)    scaleY(1);    }
    68%  { transform: translate(62px,0) rotate(-11deg)  scaleY(1);    }
    73%  { transform: translate(44px,0) rotate(11deg)   scaleY(1);    }
    79%  { transform: translate(27px,0) rotate(-9deg)   scaleY(1);    }
    85%  { transform: translate(13px,0) rotate(8deg)    scaleY(1);    }
    91%  { transform: translate(5px,0)  rotate(-4deg)   scaleY(1);    }
    96%  { transform: translate(1px,0)  rotate(2deg)    scaleY(1);    }
    100% { transform: translate(0,0)    rotate(0deg)    scaleY(1);    }
  }
  .layingegg { animation: layegg-anim 12s linear forwards; transform-origin: bottom center; }
  @keyframes egg-hatch {
    0%,20% { transform: scale(0);                               opacity: 0; }
    26%    { transform: scale(1.15);                            opacity: 1; }
    30%    { transform: scale(1) translate(0,0) rotate(0deg);   opacity: 1; }
    44%    { transform: scale(1) translate(0,0) rotate(0deg);   opacity: 1; }
    48%    { transform: scale(1) translate(-4px,0) rotate(-6deg); opacity: 1; }
    51%    { transform: scale(1) translate(4px,0)  rotate(6deg);  opacity: 1; }
    54%    { transform: scale(1) translate(-3px,0) rotate(-5deg); opacity: 1; }
    57%    { transform: scale(1) translate(2px,0)  rotate(3deg);  opacity: 1; }
    60%    { transform: scale(0);                               opacity: 0; }
    100%   { transform: scale(0);                               opacity: 0; }
  }
  .egg-anim { transform-box: fill-box; transform-origin: center; animation: egg-hatch 12s linear forwards; }
  ...
  .egg-crack-1 { animation: crack-appear 12s linear forwards; }
  .egg-crack-2 { animation: crack-appear 12s linear forwards; animation-delay: 0.4s; }
  @keyframes baby-wobble {
    0%,57% { transform: translateX(0)     rotate(0deg);   opacity: 0; }
    62%    { transform: translateX(0)     rotate(0deg);   opacity: 1; }
    68%    { transform: translateX(-48px)  rotate(-12deg); opacity: 1; }
    74%    { transform: translateX(-100px) rotate(12deg);  opacity: 1; }
    80%    { transform: translateX(-162px) rotate(-12deg); opacity: 1; }
    87%    { transform: translateX(-236px) rotate(10deg);  opacity: 1; }
    94%    { transform: translateX(-310px) rotate(-8deg);  opacity: 1; }
    100%   { transform: translateX(-370px) rotate(5deg);   opacity: 1; }
  }
  .baby-anim { animation: baby-wobble 12s linear forwards; }
  ...
  /* Penny's RIGHT wing reaches toward PinkPenny — negative rotation extends it right */
  ...
  /* PinkPenny's LEFT wing reaches toward Penny — positive rotation extends it left */
  ...
  #sm-eye-r {
    transform-box: fill-box;
    transform-origin: center;
    animation: snowman-wink 5s ease-in-out infinite;
  }
...
const STEPS = [
  { a: `Hi! I'm Penny! 🐧\nWhat is your name?` },
  { a: (n) => `¡Hola, ${n}! Nice to meet you! 🎉\nHow are you today?` },
  { a: `That's great! 😊\nCan you say… BLUE?` },
  { a: `¡Muy bien! Blue! Like my feathers! 🔵\nNow — what color is the sky?` },
  { a: (n) => `Yes! The sky is BLUE! ☀️\nYou are so smart, ${n || 'amigo'}!` },
];

/* ── Penny animations ───────────────────────────────────────────────────────── */
const ANIMS = [
  { id: 'look',     label: 'Move Head Side to Side', icon: '👀', dur: 3000  },
  { id: 'wave',     label: 'Wave',                   icon: '👋', dur: 4000  },
  { id: 'bounce',   label: 'Bounce',                 icon: '😄', dur: 2200  },
  { id: 'flap',     label: 'Flap',                   icon: '🎉', dur: 3000  },
  { id: 'shimmy',   label: 'Move Body Side to Side', icon: '💃', dur: 2800  },
  { id: 'flyaway',  label: 'Fly Away',               icon: '🐦', dur: 10000 },
  { id: 'kick',     label: 'Kick',                   icon: '🦵', dur: 7000  },
  { id: 'sleep',    label: 'Fall Asleep',             icon: '😴', dur: 7000  },
  { id: 'backflip', label: 'Backflip',               icon: '🤸', dur: 3500  },
  { id: 'magic',    label: 'Magic Disappear',        icon: '✨', dur: 8000  },
  { id: 'layegg',    label: 'Lay Egg',                icon: '🥚', dur: 12000 },
  { id: 'holdhands', label: 'Hold Hands',             icon: '💕', dur: 14000 },
];
...
function OutdoorScene() {
  return (
    <svg viewBox="0 0 880 400" preserveAspectRatio="xMidYMid slice"
      ...
      <ellipse cx="34" cy="212" rx="16" ry="18" fill="#388E3C"/>
      <rect x="58" y="252" width="9"  height="38" rx="2" fill="#5D4037"/>
      <ellipse cx="63" cy="240" rx="18" ry="22" fill="#33691E"/>
      <ellipse cx="63" cy="228" rx="12" ry="15" fill="#558B2F"/>
      {/* Trees right */}
      <rect x="820" y="236" width="11" height="54" rx="2" fill="#5D4037"/>
      <ellipse cx="826" cy="222" rx="22" ry="28" fill="#2E7D32"/>
      <ellipse cx="826" cy="208" rx="16" ry="18" fill="#388E3C"/>
      <rect x="848" y="248" width="9"  height="40" rx="2" fill="#5D4037"/>
      <ellipse cx="853" cy="236" rx="18" ry="22" fill="#33691E"/>
      <ellipse cx="853" cy="224" rx="12" ry="15" fill="#558B2F"/>
      {/* Mid hill */}
      <path d="M0,312 Q115,275 245,298 Q372,322 520,282 Q645,248 765,285 Q825,305 880,282 L880,400 L0,400Z" fill="#4CAF50"/>
      {/* Ground */}
      <rect y="352" width="880" height="48" fill="#388E3C"/>
      {/* Grass tufts */}
      {[50,135,225,325,435,535,625,715,805,850].map((x,i) => (
        <g key={i}>
          <path d={`M${x},352 Q${x+5},340 ${x+10},352`}   fill="none" stroke="#2E7D32" strokeWidth="2.5" strokeLinecap="round"/>
          <path d={`M${x+8},352 Q${x+13},342 ${x+18},352`} fill="none" stroke="#2E7D32" strokeWidth="2"   strokeLinecap="round"/>
        </g>
      ))}
      <path d="M0,354 Q220,348 440,354 Q660,360 880,354" fill="none" stroke="#81C784" strokeWidth="2" opacity="0.5"/>
    </svg>
  );
}
...
function BeachScene() {
  ...
  return (
    <svg viewBox="0 0 880 400" preserveAspectRatio="xMidYMid slice"
      ...
      {/* Foam edge */}
      <path d="M0,350 Q110,344 220,350 Q330,356 440,350 Q550,344 660,350 Q770,356 880,350"
        fill="rgba(255,255,255,0.55)" stroke="none"/>
      {/* Fish — all face left, swim right→left at staggered depths */}
      <g className="fish-1" opacity="0.88" style={{ willChange:'transform' }}>
        ...
        <path d="M-2,285 Q2,279 6,285"           fill="#FF9800" opacity="0.85"/>
        <circle cx="-6"   cy="290" r="2.5"       fill="white"/>
        <circle cx="-6.5" cy="290" r="1.2"       fill="#1a1a2e"/>
        <path d="M-13,292 Q-11,295 -10,292"      fill="none" stroke="#D47A00" strokeWidth="1" strokeLinecap="round"/>
      </g>
      <g className="fish-2" opacity="0.82" style={{ willChange:'transform' }}>
        ...
        <path d="M-1,310 Q3,305 7,310"           fill="#00ACC1" opacity="0.85"/>
      ...
      <g className="fish-3" opacity="0.80" style={{ willChange:'transform' }}>
        ...
        <path d="M-1,275 Q2,271 6,275"           fill="#F9A825" opacity="0.85"/>
        <circle cx="-4"   cy="278" r="1.8"       fill="white"/>
        <circle cx="-4.5" cy="278" r="0.9"       fill="#1a1a2e"/>
      </g>
      <g className="fish-4" opacity="0.74" style={{ willChange:'transform' }}>
        ...
        <path d="M-1,328 Q3,322 7,328"            fill="#EC407A" opacity="0.8"/>
        <circle cx="-5"   cy="332" r="2.2"        fill="white"/>
        <circle cx="-5.5" cy="332" r="1.1"        fill="#1a1a2e"/>
      </g>
      {/* Seashells */}
...
function ClassroomScene() {
  return (
    <svg viewBox="0 0 880 400" preserveAspectRatio="xMidYMid slice"
      ...
      {/* Chalk text */}
      <text x="440" y="148" textAnchor="middle" fill="white" fontSize="34" fontWeight="900"
        fontFamily="Arial" opacity="0.92">Hello! / ¡Hola!</text>
      <line x1="270" y1="170" x2="610" y2="170" stroke="rgba(255,255,255,0.3)" strokeWidth="1.5"/>
      <text x="440" y="205" textAnchor="middle" fill="rgba(255,255,255,0.72)" fontSize="22" fontFamily="Arial">
        A B C  ·  1 2 3
      </text>
      {/* Chalk bits */}
      <rect x="260" y="272" width="18" height="7" rx="3" fill="#ECEFF1" opacity="0.8"/>
      <rect x="288" y="274" width="12" height="6" rx="3" fill="#ECEFF1" opacity="0.6"/>
      {/* Floor */}
      ...
      <line x1="0" y1="354" x2="880" y2="354" stroke="rgba(0,0,0,0.1)" strokeWidth="1"/>
      {/* Teacher's desk */}
...
function SnowyScene() {
  const flakes = [
    {cx:75,  cy:-12, r:5, dur:'4.2s', delay:'0s'    },
    {cx:195, cy:-22, r:4, dur:'5.1s', delay:'-1.5s' },
    {cx:345, cy:-6,  r:6, dur:'3.8s', delay:'-0.8s' },
    {cx:475, cy:-16, r:3, dur:'4.6s', delay:'-2.3s' },
    {cx:598, cy:-9,  r:5, dur:'4.0s', delay:'-1.1s' },
    {cx:718, cy:-19, r:4, dur:'5.5s', delay:'-3.0s' },
    {cx:818, cy:-11, r:6, dur:'3.5s', delay:'-0.5s' },
    {cx:148, cy:-26, r:3, dur:'4.8s', delay:'-2.8s' },
    {cx:548, cy:-13, r:4, dur:'4.3s', delay:'-1.7s' },
    {cx:668, cy:-7,  r:5, dur:'5.0s', delay:'-3.5s' },
    {cx:420, cy:-18, r:3, dur:'4.4s', delay:'-0.3s' },
    {cx:260, cy:-10, r:4, dur:'3.9s', delay:'-2.0s' },
  ];
  return (
    <svg viewBox="0 0 880 400" preserveAspectRatio="xMidYMid slice"
      style={{ position:'absolute', inset:0, width:'100%', height:'100%' }}>
      <defs>
        <linearGradient id="sn-sky" x1="0" y1="0" x2="0" y2="1">
          ...
          <stop offset="55%"  stopColor="#B0BEC5"/>
      ...
      <path d="M30,325 Q65,312 100,325" fill="white" opacity="0.65"/>
      <path d="M40,282 Q65,271 90,282"  fill="white" opacity="0.65"/>
      {/* Pine tree right */}
      ...
      <path d="M782,320 Q820,308 858,320" fill="white" opacity="0.65"/>
      <path d="M792,278 Q820,266 848,278" fill="white" opacity="0.65"/>
      {/* Pine tree center */}
      <polygon points="572,326 606,234 640,326"  fill="#1B5E20"/>
      <polygon points="582,285 606,220 630,285"   fill="#2E7D32"/>
      <polygon points="592,256 606,207 620,256"   fill="#388E3C"/>
      <rect x="601" y="323" width="10" height="25" rx="2" fill="#4E342E"/>
      <path d="M572,326 Q606,314 640,326" fill="white" opacity="0.65"/>
      <path d="M582,285 Q606,273 630,285" fill="white" opacity="0.65"/>
      {/* Snowman — centered in open middle zone */}
      ...
      <circle cx="440" cy="235" r="2.5" fill="#37474F"/>
      <circle cx="440" cy="246" r="2.5" fill="#37474F"/>
      {/* Arms */}
...
function CityScene() {
  const windows = [
    [108,165],[113,180],[128,165],[128,180],
    [218,150],[218,165],[228,150],[228,165],[238,150],
    [338,170],[338,185],[353,170],[353,185],
    [453,180],[463,180],[453,195],[463,195],
    [523,158],[523,173],[533,158],[533,173],
    [578,172],[588,172],[578,187],[588,187],
    [648,162],[658,162],[648,177],[658,177],
    [703,188],[713,188],[703,203],
    [763,158],[773,158],[763,173],
    [823,175],[833,175],[823,190],[833,190],
  ];
  return (
    <svg viewBox="0 0 880 400" preserveAspectRatio="xMidYMid slice"
      style={{ position:'absolute', inset:0, width:'100%', height:'100%' }}>
      ...
      {[40,125,245,385,505,645,765,862,92,305,455,625,802].map((x,i) => (
        <circle key={i} cx={x} cy={18+(i%5)*16} r={i%3===0?1.8:1.1}
      ...
      {[20,100,180,260,340,420,500,580,660,740,820].map((x,i) => (
        <rect key={i} x={x} y="358" width="42" height="6" rx="3" fill="#444" opacity="0.6"/>
      ))}
      {/* Walking person 1 */}
      ...
      {/* Walking person 2 — smaller, further back */}
...
function PenguinSVG({ talking, blinking, looking, waving, flapping }) {
  ...
  return (
    <svg viewBox="0 10 680 720" className={cls}
      ...
      <path d="M280,340 Q300,330 320,338" fill="none" stroke="#DB2777" strokeWidth="1" opacity="0.6"/>
      <path d="M260,370 Q290,358 318,368" fill="none" stroke="#DB2777" strokeWidth="1" opacity="0.5"/>
      <path d="M360,340 Q380,330 400,338" fill="none" stroke="#DB2777" strokeWidth="1" opacity="0.6"/>
      <path d="M362,370 Q390,358 420,368" fill="none" stroke="#DB2777" strokeWidth="1" opacity="0.5"/>
      ...
      <path d="M308,355 Q330,346 350,354" fill="none" stroke="#FFFFFF" strokeWidth="2" opacity="0.5" strokeLinecap="round"/>
      <g id="head-group">
      ...
      <path d="M240,180 Q270,165 300,178" fill="none" stroke="#DB2777" strokeWidth="1.2" opacity="0.55"/>
      <path d="M380,178 Q410,165 440,180" fill="none" stroke="#DB2777" strokeWidth="1.2" opacity="0.55"/>
      <path d="M330,110 C326,90 318,76 324,62 C330,50 346,50 350,64 C354,76 348,92 340,108Z" fill="#BE185D"/>
      <path d="M340,110 C340,90 335,75 340,62 C345,75 342,90 342,110Z" fill="#EC4899"/>
      ...
      <circle cx="265" cy="211" r="3" fill="#D4A800"/><circle cx="323" cy="211" r="3" fill="#D4A800"/>
      <circle cx="357" cy="211" r="3" fill="#D4A800"/><circle cx="415" cy="211" r="3" fill="#D4A800"/>
      <circle cx="265" cy="245" r="3" fill="#D4A800"/><circle cx="323" cy="245" r="3" fill="#D4A800"/>
      <circle cx="357" cy="245" r="3" fill="#D4A800"/><circle cx="415" cy="245" r="3" fill="#D4A800"/>
      <g id="beak">
        ...
        <path d="M328,276 Q340,272 352,276" fill="none" stroke="#FFC947" strokeWidth="1.5" strokeLinecap="round" opacity="0.7"/>
      </g>
      ...
      <ellipse cx="340" cy="500" rx="6" ry="8" fill="#FBCFE8" opacity="0.5"/>
    </svg>
  );
}
...
function Boy() {
  return (
    <svg viewBox="0 5 220 322" style={{ width: 148, height: 'auto', display: 'block', overflow: 'visible' }}
      ...
      {/* mouth — roughly at y=130, x=110 in this viewBox */}
...
/* ── Penny speech bubble — top-left corner, tail points DOWN toward Penny ─────── */
function PennyBubble({ text }) {
  return (
    <div className="bubble-in" style={{ position: 'relative' }}>
      <div style={{
        background: 'white',
      ...
      {/* white inner tail — base overlaps 3px into bubble to hide seam */}
      <span style={{
        position: 'absolute',
        bottom: -11, left: 25,
        width: 0, height: 0,
...
/* ── Santiago input bubble — top-right corner, tail points DOWN toward Santiago ─ */
function SantiagoBubble({ value, onChange, onSubmit, disabled }) {
  return (
    <div style={{ position: 'relative' }}>
      <div style={{
        ...
        <textarea
          ...
          onKeyDown={e => { if (e.key === 'Enter' && !e.shiftKey && !disabled) { e.preventDefault(); onSubmit(); } }}
          ...
          style={{
            ...
            flex: 1, color: '#1e293b', background: 'transparent',
            fontFamily: 'inherit', resize: 'none', lineHeight: 1.45,
          }}
        />
        <button className="send-btn" onClick={onSubmit} disabled={disabled}
          style={{
            ...
            fontFamily: 'inherit', alignSelf: 'flex-end', flexShrink: 0,
          }}>
          ➤
        </button>
      </div>
...
/* ── Green Penny (Hold Hands friend — boy penguin) ───────────────────────────── */
function GreenPenny() {
  return (
  ...
  return (
    <svg viewBox="0 0 80 104" style={{ width: 64, height: 'auto', display: 'block', overflow: 'visible' }}
      ...
      <g className="egg-anim">
        <ellipse cx="40" cy="58" rx="28" ry="38"
          fill="#FFF9E6" stroke="#D4A800" strokeWidth="2.5"/>
        <path className="egg-crack-1" d="M34,46 L38,56 L32,62"
          fill="none" stroke="#C84B00" strokeWidth="2" strokeLinecap="round"/>
        <path className="egg-crack-2" d="M46,44 L42,54 L48,60"
          fill="none" stroke="#C84B00" strokeWidth="2" strokeLinecap="round"/>
      </g>
    </svg>
  );
...
export default function ChatPreview() {
  const [activeScene, setActiveScene] = useState('outdoor');
  const [input,       setInput]       = useState('');
  const [penguinText, setPenguinText] = useState(STEPS[0].a);
  ...
  const triggerAnim = (id, dur) => {
    if (activeAnim) return;
    clearTimeout(animTimerRef.current);
    setActiveAnim(id);
    animTimerRef.current = setTimeout(() => setActiveAnim(null), dur);
  };
  ...
  const speak = (text) => {
    ...
    const clean = text.replace(/\p{Extended_Pictographic}/gu, '').replace(/[¡¿\n]/g, ' ').trim();
    const utt   = new SpeechSynthesisUtterance(clean);
    utt.volume  = 1;
    const voices  = window.speechSynthesis.getVoices();
    const pick    = (names) => voices.find(v => names.some(n => v.name.includes(n)));
    const voice   = pick(['Google UK English Female', 'Google US English'])
                 || pick(['Samantha', 'Karen', 'Moira'])
                 || pick(['Microsoft Zira', 'Microsoft Eva'])
                 || voices.find(v => v.lang === 'en-US' && v.localService)
                 || null;
    if (voice) utt.voice = voice;
    const isGoogle = voice?.name?.includes('Google');
    utt.pitch = isGoogle ? 1.6 : 1.9;
    utt.rate  = isGoogle ? 1.0 : 0.92;
    utt.onstart = () => setTalking(true);
    utt.onend   = () => { setTalking(false); setWaiting(false); };
    utt.onerror = () => { setTalking(false); setWaiting(false); };
  ...
  const handleSubmit = () => {
    ...
    setTimeout(() => {
      ...
      const reply   = typeof current.a === 'function'
        ? current.a(step === 1 ? val : name)
        : current.a;
      if (step === 1) setName(val);
      if (step < STEPS.length - 1) setStep(s => s + 1);
      setPenguinText(reply);
      setBubbleKey(k => k + 1);
      speak(reply);
    }, 600);
  };
    ...
    <>
      ...
      <div style={{
        ...
        <div style={{
          ...
          overflow: 'visible',  /* bubbles can exceed frame */
        }}>

          {/* background layer — clipped inside border */}
          <div style={{
            position: 'absolute', inset: 0,
            borderRadius: 16, overflow: 'hidden',
          }}>
            {activeScene === 'outdoor'   && <OutdoorScene />}
            {activeScene === 'beach'     && <BeachScene />}
            {activeScene === 'classroom' && <ClassroomScene />}
            {activeScene === 'snowy'     && <SnowyScene />}
            {activeScene === 'city'      && <CityScene />}
          </div>

          {/* ── Penny bubble — top-left corner ── */}
          <div style={{ position: 'absolute', top: 14, left: 14, zIndex: 10 }}>
            <PennyBubble key={bubbleKey} text={penguinText} />
          </div>

          {/* ── Santiago bubble — top-right corner ── */}
          ...
          {/* ── Character layer — clips all character animations at scene edge ── */}
          <div style={{ position:'absolute', inset:0, borderRadius:16, overflow:'hidden', zIndex:5 }}>

          {/* Pink Penny wobbles in from the RIGHT — rendered AFTER Penny so she sits in front */}
          ...
          {/* Hearts float up between them — delayed ~5s until both wings are extended */}
          {activeAnim === 'holdhands' && <>
            ...
            <span className="heart-floater" style={{ bottom:'56%', left:'22%', animationDelay:'7.4s', animationFillMode:'backwards' }}>♥</span>
            <span className="heart-floater" style={{ bottom:'53%', left:'18%', animationDelay:'8.0s', animationFillMode:'backwards' }}>♥</span>
          </>}

          {/* Egg + hatching baby — rendered BEFORE penguin so they sit behind Penny */}
          {activeAnim === 'layegg' && <>
            <div style={{ position: 'absolute', bottom: 0, left: 'calc(6% + 50px)' }}>
              <EggSVG />
            </div>
            <div className="baby-anim" style={{ position: 'absolute', bottom: 0, left: 'calc(6% + 50px)' }}>
              <BabyPenguin />
            </div>
          </>}

          {/* ── Penguin zone — left side, standing on ground ── */}
          <div
            className={
              activeAnim === 'bounce'   ? 'bouncing'     :
              activeAnim === 'shimmy'   ? 'shimmying'    :
              activeAnim === 'flyaway'  ? 'flyingaway'   :
              activeAnim === 'kick'     ? 'kicking'      :
              activeAnim === 'sleep'    ? 'sleeping'     :
              activeAnim === 'backflip' ? 'backflipping' :
              activeAnim === 'magic'     ? 'magicking'    :
              activeAnim === 'layegg'   ? 'layingegg'    :
              activeAnim === 'holdhands'? 'holding'      : undefined
            }
            style={{ position: 'absolute', bottom: '0%', left: '6%' }}>
            <div className="penguin-wrap">
              <PenguinSVG
                talking={talking}   blinking={blinking}
          ...
          {/* ── Boy zone — right side, standing on ground ── */}
          <div style={{ position: 'absolute', bottom: '0%', right: '6%' }}>
            <Boy />
          </div>

          {/* Z's — float up when Penny falls asleep */}
          {activeAnim === 'sleep' && <>
        ...
        <div style={{ display:'flex', gap:8, marginTop:12, justifyContent:'center', flexWrap:'wrap' }}>
          {[
            ...
            { id:'snowy',     icon:'❄️', label:'Snowy'    },
            { id:'city',      icon:'🌃', label:'City'     },
          ].map(s => (
            <button key={s.id} onClick={() => setActiveScene(s.id)} style={{
              background:  activeScene === s.id ? '#1D4ED8' : 'white',
              color:       activeScene === s.id ? 'white'   : '#1D4ED8',
        ...
        {/* Penny animation controls */}
        <div style={{ display:'flex', gap:8, marginTop:8, justifyContent:'center', flexWrap:'wrap', alignItems:'center' }}>
          <span style={{ fontSize:12, fontWeight:700, color:'#6B7280', letterSpacing:'0.05em' }}>PENNY:</span>
          {ANIMS.map(a => (
            <button key={a.id} onClick={() => triggerAnim(a.id, a.dur)} disabled={!!activeAnim}
              style={{
                background:   activeAnim === a.id ? '#7C3AED' : !!activeAnim ? '#F1F5F9' : 'white',
                color:        activeAnim === a.id ? 'white'   : !!activeAnim ? '#94A3B8' : '#7C3AED',
                border:       `2px solid ${activeAnim === a.id ? '#7C3AED' : !!activeAnim ? '#CBD5E1' : '#7C3AED'}`,
                borderRadius:  20, padding: '5px 13px', fontSize: 13, fontWeight: 700,
                cursor:       !!activeAnim ? 'default' : 'pointer',
        ...
        {/* name labels below frame */}
        <div style={{
          display: 'flex', justifyContent: 'space-between',
          width: '100%', maxWidth: 880,
          marginTop: 8, padding: '0 6%',
          boxSizing: 'border-box',
        }}>
          <span style={{ fontSize: 13, fontWeight: 800, color: '#3B82F6', letterSpacing: '0.06em' }}>
            🐧 PENNY
          </span>
          <span style={{ fontSize: 13, fontWeight: 800, color: '#3B82F6', letterSpacing: '0.06em' }}>
            SANTIAGO ✏️
