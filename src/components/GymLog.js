...
const MUSCLE_GROUPS = [
    ...
    subcategories: [
      ...
      },
      {
        ...
        exercises: [
          ...
          { id: 'rear-delt-fly-dumbbell', label: 'Rear Delt Fly (DB)'     },
      ...
      },
      {
        label: 'Traps',
        exercises: [
          { id: 'dumbbell-shrug', label: 'DB Shrug' },
        ],
      },
    ],
  },
  {
    ...
    label: 'Shoulders',
    exercises: [
      { id: 'shoulder-press-dumbbells', label: 'Shoulder Press (DB)' },
      { id: 'shoulder-press-machine',   label: 'Shoulder Press (Machine)'   },
      { id: 'arnold-press-dumbbells',   label: 'Arnold Press (DB)'   },
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: 'bench-press-dumbbells',  label: 'Bench Press (DB)'  },
      { id: 'bench-press-smith',      label: 'Bench Press (Smith)'      },
      { id: 'incline-press-dumbbells', label: 'Incline Press (DB)' },
  ...
  },
  {
    ...
    label: 'Biceps',
    exercises: [
      { id: 'curls-dumbbells-seated',              label: 'Curls (DB Seated)'              },
      { id: 'curls-dumbbells-standing',            label: 'Curls (DB Standing)'            },
      { id: 'preacher-curl-dumbbell-bench',        label: 'Preacher Curl (DB Bench)'        },
      { id: 'hammer-curls-dumbbells-seated',       label: 'Hammer Curls (DB Seated)'       },
      { id: 'hammer-curls-dumbbells-standing',     label: 'Hammer Curls (DB Standing)'     },
      { id: 'incline-curls-dumbbells-seated',      label: 'Incline Curls (DB Seated)'      },
      { id: 'concentration-curls-dumbbells-seated', label: 'Concentration Curls (DB Seated)' },
      { id: 'reverse-curls-barbells-standing',     label: 'Reverse Curls (BB Standing)'     },
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: 'triceps-extensions-bench-dumbbells',   label: 'Triceps Extensions (DB)' },
